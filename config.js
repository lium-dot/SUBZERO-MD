...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~OG1ygI8pt8p7dzOpH7GS",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "A༙l༙l༙e༙n༙",           // Owner's name
    ...
    FOOTER: process.env.FOOTER || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫*",  // Bot description
