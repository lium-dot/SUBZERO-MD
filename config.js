...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~OMCEfCN7NavSfTVSB6kG",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || "★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫",           // Owner's name
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || " *Ꭿℒℒℰℕ ℐЅ ᏇᎯTℂℋℐℕᎶ👀ℐℕ ᎶℋᎾЅT ℳᎾⅅℰ👻 *",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "ᴘσωєʀє∂ ву ★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫",     // Sticker pack name
    ...
    BOT_IMAGE: process.env.BOT_IMAGE || "https://i.ibb.co/h0Sw13b/file-1285.jpg",  // Bot's "alive" image
    ...
    FOOTER: process.env.FOOTER || "*© ᴘσωєʀє∂ ву ★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫*",  // Bot description
